# Policy: vault-reader-staging
# Read-only access for authenticated STAGING platform users
# GAP-CONF-014 (P1) + FIX-009 Phase 1: Replace secret/data/* wildcard
# Date: 2026-03-26 | Security & Resilience Specialist
#
# Phase 1: staging/* + shared service paths (read-only)
# Phase 2 TODO: Migrate all secrets to staging/service/*
