...
# init-terraform.sh
# Script para inicializar Terraform com backend remoto S3
# Este script carrega as credenciais AWS automaticamente e executa terraform init
#
...
echo ""
echo "[STEP] Executando terraform init..."
terraform init

echo ""
echo "[SUCCESS] Terraform inicializado com sucesso!"
echo ""
echo "Próximos comandos:"
echo "  terraform plan   - Ver mudanças planejadas"
