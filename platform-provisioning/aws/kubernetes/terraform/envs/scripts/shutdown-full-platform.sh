...
echo "  - 7 nodes EC2"
echo "  - Pods (ALB Controller, Cert-Manager, Prometheus, Grafana)"
echo "  - 4 add-ons EKS"
echo ""
...
echo "  - EBS Volumes (PVCs) - \$2.16/mês (~27GB para Prometheus/Grafana/Alertmanager)"
echo "    * Grafana: 5Gi = \$0.40/mês"
echo "    * Prometheus: 20Gi = \$1.60/mês"
echo "    * Alertmanager: 2Gi = \$0.16/mês"
echo "  ℹ️  Volumes são mantidos para preservar dados históricos"
echo ""

echo "💰 Custo atual enquanto desligado: ~\$0.09/hora + \$2.16/mês"
echo "   (NAT Gateways \$66/mês + Volumes \$2.16/mês = ~\$68/mês)"
echo ""
